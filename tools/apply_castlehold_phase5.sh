...
for item in assets scripts docs tests CASTLEHOLD_REUSE_PHASE1.md CASTLEHOLD_REUSE_PHASE2.md CASTLEHOLD_REUSE_PHASE3.md CASTLEHOLD_REUSE_PHASE4.md CASTLEHOLD_REUSE_PHASE5.md; do
...
echo "Ogre War Phase 5 current-generation presentation update copied to $DEST"
